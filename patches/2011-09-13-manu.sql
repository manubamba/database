...
DROP SCHEMA IF EXISTS `massidea` ;
CREATE SCHEMA IF NOT EXISTS `massidea` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `massidea` ;

-- -----------------------------------------------------
-- Table `massidea`.`countries`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`countries` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`countries` (
...
-- -----------------------------------------------------
-- Table `massidea`.`towns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`towns` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`towns` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(50) NOT NULL ,
  ...
  CONSTRAINT `fk_towns_countries1`
    ...
    REFERENCES `massidea`.`countries` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`languages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`languages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`languages` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(50) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`users` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_users_towns1`
    FOREIGN KEY (`town_id` )
    REFERENCES `massidea`.`towns` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_languages1`
    FOREIGN KEY (`language_id` )
    REFERENCES `massidea`.`languages` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `massidea`.`contents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` TEXT NULL ,
  `lead` TEXT NULL ,
  `body` TEXT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`personal_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`personal_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`personal_tags` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`flags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`flags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`flags` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `created` DATETIME NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`files`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`files` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`files` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(255) NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`deny_translations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`deny_translations` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`deny_translations` (
  `user_id` INT NOT NULL ,
  `language_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`ratings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`ratings` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`ratings` (
...
-- -----------------------------------------------------
-- Table `massidea`.`related_companies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`related_companies` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`related_companies` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(255) NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`stats`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`stats` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`stats` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `user_id` INT NOT NULL ,
  `key` INT NOT NULL ,
  `value` INT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`privileges`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`privileges` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`privileges` (
  `user_id` INT NOT NULL ,
  `group` INT NULL )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`comments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`comments` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`comments` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `user_id` INT NOT NULL ,
  `parent_id` INT NULL ,
  `lft` INT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`linked_contents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`linked_contents` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`linked_contents` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `from` INT NOT NULL ,
  `to` INT NOT NULL ,
  `created` DATETIME NULL ,
  ...
  CONSTRAINT `fk_linked_contents_contents1`
    FOREIGN KEY (`from` )
    REFERENCES `massidea`.`contents` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `massidea`.`requests`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`requests` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`requests` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`tokens`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`tokens` ;
...
-- -----------------------------------------------------
-- Table `massidea`.`private_messages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`private_messages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`private_messages` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_ratings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_ratings` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_ratings` (
  ...
  CONSTRAINT `fk_contents_ratings_ratings1`
    ...
    REFERENCES `massidea`.`ratings` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_flags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_flags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_flags` (
  `content_id` INT NOT NULL ,
...
-- Table `massidea`.`tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`tags` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(255) NULL ,
  PRIMARY KEY (`id`) ,
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) )
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_personal_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_personal_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_personal_tags` (
  `content_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_contents_personal_tags_personal_tags1`
    ...
    REFERENCES `massidea`.`personal_tags` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_tags` (
  `content_id` INT NOT NULL ,
  `tag_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_related_companies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_related_companies` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_related_companies` (
  `content_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_contents_related_companies_related_companies1`
    ...
    REFERENCES `massidea`.`related_companies` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_files`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_files` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_files` (
  `content_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_towns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_towns` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_towns` (
  `content_id` INT NOT NULL ,
  `town_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_contents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_contents` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_contents` (
  ...
  CONSTRAINT `fk_campaigns_contents_campaigns1`
    ...
    REFERENCES `massidea`.`campaigns` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_groups` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_groups` (
  `content_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_users` (
  `content_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`comments_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`comments_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`comments_users` (
  `comment_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
  PRIMARY KEY (`comment_id`, `user_id`) ,
  INDEX `fk_comments_users_users1` (`user_id` ASC) ,
  INDEX `fk_comments_users_comments1` (`comment_id` ASC) ,
  CONSTRAINT `fk_comments_users_comments1`
    FOREIGN KEY (`comment_id` )
    REFERENCES `massidea`.`comments` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_comments_users_users1`
    FOREIGN KEY (`user_id` )
    REFERENCES `massidea`.`users` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `massidea`.`private_messages_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`private_messages_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`private_messages_users` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`tags_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`tags_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`tags_users` (
  `tag_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`flags_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`flags_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`flags_users` (
  `flag_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`user_roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`user_roles` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`user_roles` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_users` (
  `group_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_groups_users_user_roles1`
    ...
    REFERENCES `massidea`.`user_roles` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_users` (
  `campaign_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_groups` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_groups` (
  `campaign_id` INT NOT NULL ,
  `group_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_tags` (
  `campaign_id` INT NOT NULL ,
  `tag_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_private_messages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_private_messages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_private_messages` (
  `campaign_id` INT NOT NULL ,
  `private_message_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`users_private_messages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`users_private_messages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`users_private_messages` (
  `private_message_id` INT NOT NULL ,
  `sender` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_towns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_towns` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_towns` (
  `campaign_id` INT NOT NULL ,
  `town_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_comments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_comments` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_comments` (
  `campaign_id` INT NOT NULL ,
  `comment_id` INT NOT NULL ,
  PRIMARY KEY (`campaign_id`, `comment_id`) ,
  INDEX `fk_campaigns_comments_comments1` (`comment_id` ASC) ,
  ...
  CONSTRAINT `fk_campaigns_comments_campaigns1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_campaigns_comments_comments1`
    FOREIGN KEY (`comment_id` )
    REFERENCES `massidea`.`comments` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_ratings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_ratings` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_ratings` (
  `campaign_id` INT NOT NULL ,
  `rating_id` INT UNSIGNED NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_flags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_flags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_flags` (
  `campaign_id` INT NOT NULL ,
  `flag_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_files`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_files` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_files` (
  `campaign_id` INT NOT NULL ,
  `file_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_languages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_languages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_languages` (
  `campaign_id` INT NOT NULL ,
  `language_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`linked_campaigns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`linked_campaigns` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`linked_campaigns` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `from` INT NOT NULL ,
  `to` INT NOT NULL ,
  `created` DATETIME NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`linked_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`linked_groups` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`linked_groups` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `from` INT NOT NULL ,
  `to` INT NOT NULL ,
  `created` DATETIME NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`personal_tags_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`personal_tags_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`personal_tags_users` (
  `personal_tag_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_personal_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_personal_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_personal_tags` (
  `campaign_id` INT NOT NULL ,
  `personal_tag_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_related_companies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_related_companies` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_related_companies` (
  `campaign_id` INT NOT NULL ,
  `related_company_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_tags` (
  `group_id` INT NOT NULL ,
  `tag_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_personal_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_personal_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_personal_tags` (
  `group_id` INT NOT NULL ,
  `personal_tag_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_private_messages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_private_messages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_private_messages` (
  `group_id` INT NOT NULL ,
  `private_message_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`comments_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`comments_groups` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`comments_groups` (
  `comment_id` INT NOT NULL ,
  `group_id` INT NOT NULL ,
  PRIMARY KEY (`comment_id`, `group_id`) ,
  INDEX `fk_comments_groups_groups1` (`group_id` ASC) ,
  INDEX `fk_comments_groups_comments1` (`comment_id` ASC) ,
  CONSTRAINT `fk_comments_groups_comments1`
    FOREIGN KEY (`comment_id` )
    REFERENCES `massidea`.`comments` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_comments_groups_groups1`
    FOREIGN KEY (`group_id` )
    REFERENCES `massidea`.`groups` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_languages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_languages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_languages` (
  `group_id` INT NOT NULL ,
  `language_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`files_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`files_groups` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`files_groups` (
  `file_id` INT NOT NULL ,
  `group_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`countries_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`countries_groups` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`countries_groups` (
  `country_id` INT NOT NULL ,
  `group_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_ratings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_ratings` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_ratings` (
  `group_id` INT NOT NULL ,
  `rating_id` INT UNSIGNED NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_towns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_towns` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_towns` (
  `group_id` INT NOT NULL ,
  `town_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_related_companies`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_related_companies` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_related_companies` (
  `group_id` INT NOT NULL ,
  `related_company_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`inbox_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`inbox_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`inbox_tags` (
  `personal_tag_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_personal_tags_private_messages_users_private_messages_users1`
    ...
    REFERENCES `massidea`.`private_messages_users` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`outbox_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`outbox_tags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`outbox_tags` (
  `private_message_id` INT NOT NULL ,
  `personal_tag_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`inbox_flags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`inbox_flags` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`inbox_flags` (
  `flag_id` INT NOT NULL ,
  `private_messages_user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`readers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`readers` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`readers` (
  `id` INT NOT NULL ,
  `created` DATETIME NULL ,
  `modified` DATETIME NULL ,
  `content_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`links`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`links` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`links` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `massidea`.`campaigns_links`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`campaigns_links` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`campaigns_links` (
  `campaign_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`links_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`links_users` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`links_users` (
  `link_id` INT NOT NULL ,
  `user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`contents_links`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`contents_links` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`contents_links` (
  `content_id` INT NOT NULL ,
  `link_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_links`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_links` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_links` (
  `group_id` INT NOT NULL ,
  `link_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`links_private_messages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`links_private_messages` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`links_private_messages` (
  `link_id` INT NOT NULL ,
  `private_message_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`groups_requests`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`groups_requests` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`groups_requests` (
  `user_id` INT NOT NULL ,
  `group_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`profiles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`profiles` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`profiles` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `user_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `massidea`.`comments_profiles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`comments_profiles` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`comments_profiles` (
  `comment_id` INT NOT NULL ,
  `profile_id` INT NOT NULL ,
  PRIMARY KEY (`comment_id`, `profile_id`) ,
  INDEX `fk_comments_profiles_profiles1` (`profile_id` ASC) ,
  INDEX `fk_comments_profiles_comments1` (`comment_id` ASC) ,
  CONSTRAINT `fk_comments_profiles_comments1`
    FOREIGN KEY (`comment_id` )
    REFERENCES `massidea`.`comments` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_comments_profiles_profiles1`
    FOREIGN KEY (`profile_id` )
    REFERENCES `massidea`.`profiles` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `massidea`.`comments_contents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea`.`comments_contents` ;

CREATE  TABLE IF NOT EXISTS `massidea`.`comments_contents` (
  `comment_id` INT NOT NULL ,
  `content_id` INT NOT NULL ,
  PRIMARY KEY (`comment_id`, `content_id`) ,
  INDEX `fk_comments_contents_contents1` (`content_id` ASC) ,
  INDEX `fk_comments_contents_comments1` (`comment_id` ASC) ,
  CONSTRAINT `fk_comments_contents_comments1`
    FOREIGN KEY (`comment_id` )
    REFERENCES `massidea`.`comments` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
