...
-- -----------------------------------------------------
-- Table `massidea2`.`comments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea2`.`comments` ;

CREATE  TABLE IF NOT EXISTS `massidea2`.`comments` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `user_id` INT NOT NULL ,
  `parent_id` INT NULL ,
  `lft` INT NULL ,
...
CREATE  TABLE IF NOT EXISTS `massidea2`.`comments_users` (
  ...
  CONSTRAINT `fk_comments_users_comments1`
    ...
    REFERENCES `massidea2`.`comments` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `massidea2`.`comments_profiles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `massidea2`.`comments_profiles` ;

CREATE  TABLE IF NOT EXISTS `massidea2`.`comments_profiles` (
  `comment_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_comments_profiles_profiles1`
    ...
    REFERENCES `massidea2`.`profiles` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
